...
def permute(
    ...
    if np_rng.binomial(1, fim_rate):
        ...
        prefix = np.array(tokenized_input_prefix, dtype=np.int64)
        middle = np.array(tokenized_input_middle, dtype=np.int64)
        suffix = np.array(tokenized_input_suffix, dtype=np.int64)
